  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden bg-gradient-to-br from-blue-100 via-white to-blue-200 text-gray-800">
      ...
      <main className="flex flex-1 flex-col-reverse lg:flex-row items-center justify-between
                      px-4 md:px-10 py-10 relative z-10 w-full max-w-7xl mx-auto">
        {/* Text Content */}
        <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left
                      w-full lg:w-1/2 xl:w-[50%] mt-8 md:mt-0 z-10 lg:pr-8 xl:pr-12">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-6xl font-extrabold mb-4 md:mb-6 text-gray-900 leading-tight">
        ...
        {/* Image - Now uses explicit width & height for better control */}
        <div className="relative flex-shrink-0 w-full md:w-2/3 lg:w-1/2 xl:w-[50%] max-w-[500px] mx-auto">
          <Image
